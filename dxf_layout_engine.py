...
def compor_dxf_personalizado(
    ...
    for plan_data in sorted_plans:
        ...
        organized_dxfs_for_current_plan = defaultdict(lambda: defaultdict(list))
        ...
        for item_data in file_ids_and_skus:
            ...
            try:
                ...
                organized_dxfs_for_current_plan[color_code][hole_type].append({
        ...
        for color_code in sorted_colors_for_current_plan:
            ...
            sorted_hole_types_for_current_plan = sorted(color_group.keys())

            first_hole_type_in_line = True
            for hole_type in sorted_hole_types_for_current_plan:
                hole_type_group = color_group[hole_type]
                
                if not first_hole_type_in_line:
                    current_x_pos += ESPACAMENTO_DXF_FURO_DIFERENTE
        ...
        # Após processar todos os itens de um plano, adicione espaçamento entre planos
